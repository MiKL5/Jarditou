<?php
    ...
    if ($nom == Null || $url == Null) {
        header("Location: artist_add.php");
        exit;
    }
    ...
    try {
        ...
        $requete = $db->prepare("INSERT INTO artist (artist_name, artist_url) VALUES (:artist_name, :artist_url);");
    ...
    // Gestion des erreurs
        ...
        die("Fin du script (script_artist_add.php)");
    }
