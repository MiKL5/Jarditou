                ...
                <div class=col-12>
                    <form action="">
                        <div class="row">
                            ...
                            <div class="d-flex">
                                <!-- bouton midifier -->
                                <a href="disc_modif.php?id=<?=$result['disc_id']?>"<button type="button" name="id" class=" btn btn-primary btn-sm mx-1 mb-4">Modifier</button>
                                <!-- bouton retour -->
                                <a href="script_disc_delete.php?id=<?= $result['disc_id']?>"<button type="button" class="btn btn-danger btn-sm mx-1 mb-4">Supprimer</button>
                                <!-- bouton ajouter -->
