<head>
    ...
    <nav class=" header navbar navbar-expand-lg bg-dark"><!-- fixed-top -->
        <div class="container-fluid">
            ...
            <!-- <div class="justify-content-between fst-italic "> -->
                ...
                if (isset($_SESSION["login"]) && $_SESSION["login"] != "") { ?>
                    ...
                    <a href="script_logout.php" title="Fermer la session" alt="Fermer la session"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-box-arrow-right text-danger mx-3" viewBox="0 0 16 16">
